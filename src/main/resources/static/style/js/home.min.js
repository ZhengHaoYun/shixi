function scoreChange(a) {
    ...
    var b = 360 * parseInt(a) / 100, c = [{value: b, color: "#009a6d"}, {value: 360 - b, color: "#ffffff"}],
...
!function (a, b) {
    ...
    function j(a, b, c) {
        var d = a.charAt(0).toUpperCase() + a.slice(1), e = (a + " " + u.join(d + " ") + d).split(" ");
        return f(b, "string") || f(b, "undefined") ? h(e, b) : (e = (a + " " + v.join(d + " ") + d).split(" "), i(e, b, c))
    }

    var r, B, D, E, k = "2.6.2", l = {}, m = !0, n = b.documentElement, o = "modernizr", p = b.createElement(o),
        q = p.style, t = ({}.toString, "Webkit Moz O ms"), u = t.split(" "), v = t.toLowerCase().split(" "), w = {},
        z = [], A = z.slice, C = {}.hasOwnProperty;
    ...
    return l.addTest = function (a, b) {
        if ("object" == typeof a) for (var d in a) D(a, d) && l.addTest(d, a[d]); else {
        ...
        var m, q, r, j = a.html5 || {}, k = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,
    ...
    function g(a) {
        a >= 0 && (f = a), $(".banner_control em").animate({top: 55 * f + "px"}, 200), $(".thumbs li").removeClass("current"), $(".thumbs li").eq(f).addClass("current"), $(".banner_bg").animate({"margin-top": "-" + 160 * f + "px"}, 200), f++, f >= e && (f = 0)
    }
    ...
    $("#icon_qq ,#icon_wb").click(function () {
            ...
            hoverDuring: 200, hoverEvent: function () {
                switch (a) {
                    ...
                    case 5:
                        ...
                        break;
                    default:
                        $(this).addClass("current").children(".menu_sub").css({top: $(this).position().top}).removeClass("dn")
                }
            }, outEvent: function () {
                $(this).removeClass("current").children(".menu_sub").addClass("dn")
            }
        })
    }), a = $("#sidebar").offset(), $(window).scroll(function () {
        var b = $(window).scrollTop(), c = d(), e = $("#sidebar").height();
        a.top <= b && c > e ? $("#sidebar").addClass("fixed") : $("#sidebar").removeClass("fixed")
    }), c = 0, $(".hotabbing li").bind("click", function () {
        ...
        $.cookie("showExpriedIndex", a - 1), $(this).parent(".tipExpire").hide()
    }), $("#resumeScore .xScore").bind("click", function () {
        $(this).parent("#resumeScore").hide(), $.ajax({
            type: "POST",
            data: {},
            url: ctx + "/resume/clearShowNoticeInSeesion.json"
        }).done(function () {
        })
    }), e = $(".banner_bg li").length, f = 1, $(".banner_bg").css("height", 160 * e + "px"), h = setInterval(g, 5e3), $(".thumbs li").hover(function () {
        if (!$(this).hasClass("current")) {
            $(".banner_bg").stop(!1, !0, !0), $(".thumbs li").stop(!1, !0, !0), $(".banner_control em").stop(!1, !0, !0), clearInterval(h);
            var a = $(this).index();
            g(a), h = setInterval(g, 5e3)
        }
    }), $(".banner_bg li").hover(function () {
        $(".banner_bg li").stop(!0, !0), $(".thumbs li").stop(!0, !0), clearInterval(h)
    }, function () {
        h = setInterval(g, 5e3)
    })
});